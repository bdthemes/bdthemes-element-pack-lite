        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '-0'      => esc_html__('UT or UTC - GMT -0', 'bdthemes-element-pack'),
                    '+1'      => esc_html__('CET - GMT+1', 'bdthemes-element-pack'),
                    '+2'      => esc_html__('EET - GMT+2', 'bdthemes-element-pack'),
                    '+3'      => esc_html__('MSK - GMT+3', 'bdthemes-element-pack'),
                    '+4'      => esc_html__('SMT - GMT+4', 'bdthemes-element-pack'),
                    '+5'      => esc_html__('PKT - GMT+5', 'bdthemes-element-pack'),
                    '+5.5'    => esc_html__('IND - GMT+5.5', 'bdthemes-element-pack'),
                    '+6'      => esc_html__('OMSK / BD - GMT+6', 'bdthemes-element-pack'),
                    '+7'      => esc_html__('CXT - GMT+7', 'bdthemes-element-pack'),
                    '+8'      => esc_html__('CST / AWST / WST - GMT+8', 'bdthemes-element-pack'),
                    '+9'      => esc_html__('JST - GMT+9', 'bdthemes-element-pack'),
                    '+10'     => esc_html__('EAST - GMT+10', 'bdthemes-element-pack'),
                    '+11'     => esc_html__('SAKT - GMT+11', 'bdthemes-element-pack'),
                    '+12'     => esc_html__('IDLE  - GMT+12', 'bdthemes-element-pack'),
                    '+13'     => esc_html__('NZDT  - GMT+13', 'bdthemes-element-pack'),
                    '-1'      => esc_html__('WAT  - GMT-1', 'bdthemes-element-pack'),
                    '-2'      => esc_html__('AT  - GMT-2', 'bdthemes-element-pack'),
                    '-3'      => esc_html__('ART  - GMT-3', 'bdthemes-element-pack'),
                    '-4'      => esc_html__('AST  - GMT-4', 'bdthemes-element-pack'),
                    '-5'      => esc_html__('EST  - GMT-5', 'bdthemes-element-pack'),
                    '-6'      => esc_html__('CST  - GMT-6', 'bdthemes-element-pack'),
                    '-7'      => esc_html__('MST  - GMT-7', 'bdthemes-element-pack'),
                    '-8'      => esc_html__('PST  - GMT-8', 'bdthemes-element-pack'),
                    '-9'      => esc_html__('AKST  - GMT-9', 'bdthemes-element-pack'),
                    '-10'     => esc_html__('HST  - GMT-10', 'bdthemes-element-pack'),
                    '-11'     => esc_html__('NT  - GMT-11', 'bdthemes-element-pack'),
                    '-12'     => esc_html__('IDLW  - GMT-12', 'bdthemes-element-pack'),
