...
$subscribe_optin = 'yes' === get_option( 'bdtep_subscribe_optin' );
	...
	<div class="bdt-subscribe-card">
		...
		<div class="bdt-subscribe-card-head">
			<span class="bdt-subscribe-guarantee">
				...
				<?php esc_html_e( 'NO SPAM GUARANTEE', 'bdthemes-element-pack-lite' ); ?>
			</span>
		</div>
		...
		<div class="bdt-subscribe-field">
			<input type="email"
				...
				autocomplete="email"
				placeholder="<?php esc_attr_e( 'Enter your email address', 'bdthemes-element-pack-lite' ); ?>"
		...
		<div class="bdt-subscribe-consent">
			<label class="bdt-subscribe-consent-label" for="bdt-subscribe-consent">
				...
				<span>
					<?php esc_html_e( 'Email me the Element Pack newsletter: news, tips and security notices. You can unsubscribe at any time.', 'bdthemes-element-pack-lite' ); ?>
				</span>
			</label>
		</div>
