...
<div class="bdt-wizard-step bdt-text-center active" data-step="welcome">
    <div class="bdt-welcome-header">
        ...
        <p><?php esc_html_e( 'Thank you for choosing Element Pack, a leading addon that provides a total web design solution for you. This quick setup wizard will help you configure the basic settings and get you started.', 'bdthemes-element-pack-lite' ); ?></p>
    </div>
